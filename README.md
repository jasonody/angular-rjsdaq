#An Angular RJSDAQ Client
An Angular implementation of a client for the RJSDAQ. Parallel development of a [ReactJS client can be found here](https://github.com/jasonody/react-rjsdaq-workshop).

**Note: All credit for the server and client's design go to [Steven Luscher and his awesome ReactJS Workshop](https://github.com/steveluscher/react-rjsdaq-workshop).**  
